...
import { downloadNotaPDF } from '../utils/pdfGenerator'; // Sesuaikan path
...
const NotaPublicPage = () => {
    ...
    return (
        <div style={{ textAlign: 'center', padding: '100px' }}>
            {loading && <Spin size="large" tip="Mempersiapkan nota..." />}
            {error && <p>Error: {error}</p>}
            {!loading && !error && <p>Download nota Anda telah dimulai. Silakan cek file download Anda.</p>}
        </div>
    );
};
