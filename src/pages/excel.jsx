...
// --- MOCK FIREBASE DIHAPUS ---
// File api/firebase.js sudah dibuat
...
const parseBookRow = (item) => {
  ...
  return {
    ...
    // Permintaan Baru:
    spek_kertas: spek, // Nilainya "LKS" atau "Buku"
    tipe_buku: tipe_buku, // Nilainya "HET" atau ""

    // Properti Sisa:
    hargaJual: 0,
    diskonJual: 0,
    
    // --- TAMBAHAN HARGA ZONA (Default 0) ---
    // Saya menggunakan snake_case (harga_zona_2) agar konsisten dengan 'kode_buku'
    harga_zona_2: 0,
    harga_zona_3: 0,
    harga_zona_4: 0,
    harga_zona_5a: 0,
    harga_zona_5b: 0,
    // --- AKHIR TAMBAHAN HARGA ZONA ---

    // 'hargaJualSpesial' dan semua properti 'cetak' dihapus
