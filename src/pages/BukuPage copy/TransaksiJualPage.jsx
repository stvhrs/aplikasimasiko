...
// Changes requested:
// - Remove "Total Buku" column
// - Implement Edit using the same form component (TransaksiJualForm)
// - When editing, show Delete button at bottom of the form
// ================================
...
useEffect(() => {
  ...
  if (statusFilter) {
    data = data.filter((tx) => {
      ...
      // "Sebagian (DP)" harus menangkap DP juga
  ...
  return <Tag color={color}>{status}</Tag>;
    ...
    {
      title: 'Aksi', key: 'aksi', align: 'center', fixed: 'right', width: 220,
      render: (_, record) => {
        const menu = (
          <Menu>
...
// - Supports mode: 'create' or 'edit'
// - In edit mode: prefill form, DO NOT auto-generate invoice, and show Delete button
// - Save in edit mode updates only the transaksi node (no stock recalculation to avoid double counting)
// ================================
