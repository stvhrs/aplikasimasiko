...
        ...values,
        isHet: !!values.isHet,
        tahunTerbit: values.tahunTerbit || '',
        hargaJual: Number(values.hargaJual) || 0,
        harga_zona_2: values.isHet ? (Number(values.harga_zona_2) || 0) : 0,
        harga_zona_3: values.isHet ? (Number(values.harga_zona_3) || 0) : 0,
        harga_zona_4: values.isHet ? (Number(values.harga_zona_4) || 0) : 0,
        harga_zona_5a: values.isHet ? (Number(values.harga_zona_5a) || 0) : 0,
        harga_zona_5b: values.isHet ? (Number(values.harga_zona_5b) || 0) : 0,
